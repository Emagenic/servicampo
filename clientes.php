...
<html lang="es">
  <head>
    ...
    <title>Nuestros Clientes Servicampo</title>
  ...
  <body class="home-page">
    ...
    <div class="cont">
      <article>
        ...
        <h4>Que Hacemos y a Quienes Atendemos.</h4>

        <p>Somos una empresa enfocada, a dar respuesta a una variada gama de exigencias sanitarias e higiene ambiental.<br></br>
        En particular, las que van relacionadas directamente con el sector agrícola y/o agroindustrial.<br></br>
        Lo cual no va en desmedro de un listado amplio de otros clientes pertenecientes a otros sectores tales como:
        - Minería - Construcción - Municipalidades<br></br>
        - Colegios - Consultorios<br></br>
        - Edificios - Poblaciones<br></br>
        - Domicilios Particulares<br></br>
        Para ello, ofrecemos una amplia gama de productos y servicios que, combinados en forma única, nos permite ofrecer "soluciones reales e integrales".
        Para lo anterior podemos hablar de instalación y mantención de plantas de tratamientos, arriendo, fabricación y venta de baños químico, limpieza de fosas, destapes con hidro jet y envarillados manuales. </p>

      </div>
      <figure>
        <img src="imagenes/nosotros/2.jpg"><br></br>
        <img src="imagenes/nosotros/3.jpg">
      </figure>
      </article>
    </div>
