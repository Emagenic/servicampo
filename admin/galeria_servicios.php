...
if ($_POST["Grabar"]){
	$insertar="INSERT INTO galeria_servicio (titulo,url,Tipo,servicio) 
...
if ($_GET["fun"] =="eli"){
	$insertar = "delete from galeria_servicio WHERE id = '".$_GET["foto"]."' " ; 
	$sentencia=mysql_query($insertar,$conn)or die("Error al grabar un mensaje: ".mysql_error);
	$dir="../galeria/servicios/". $_GET["foto"] .".jpg";
	if(file_exists($dir)) { 
		if(unlink($dir)) 
			print ""; 
		} else 
...
<body>
<form id="form1" name="form1" method="post" action="galeria_servicios.php?servicios=<?php echo $_GET["servicios"]; ?>">
...
<p align="center"><a href="servicio.php" class="textolink">Volver</a></p>
...
?>
  <tr>
    <td width="25%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><a href="../galeria/servicios/Upload_foto.php?foto=<?php echo $rs["id"]; ?>&amp;servicios=<?php echo $_GET["servicios"]; ?>" class="textolink">Cambiar foto</a></td>
      </tr>
      <tr>
        <td align="center"><img src="../galeria/servicios/<?php echo $rs["id"] ?>.jpg" width="200" /></td>
      </tr>
      <tr>
        <td align="center">
        <a href="galeria_servicios.php?id=<?php echo $_GET["id"]; ?>&fun=eli&foto=<?php  echo $rs["id"];  ?>&servicios=<?php echo $_GET["servicios"]; ?>" class="textolink">Eliminar</a>
        </td>
      </tr>
    </table></td>
    ...
    <td width="25%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center" class="textolink">
        <a href="galeria_servicios.php?id=<?php echo $_GET["id"]; ?>&fun=eli&foto=<?php  echo $rs["id"];  ?>&servicios=<?php echo $_GET["servicios"]; ?>" class="textolink">Eliminar</a>
        </td>
      </tr>
    </table></td>
    ...
    <td width="25%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center" class="textolink"><span class="textolink"><a href="galeria_servicios.php?id=<?php echo $_GET["id"]; ?>&fun=eli&foto=<?php  echo $rs["id"];  ?>&servicios=<?php echo $_GET["servicios"]; ?>" class="textolink">Eliminar</a></span></td>
      </tr>
    </table></td>
  </tr>
  <?php }}}} ?>
