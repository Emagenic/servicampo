                      ...
                      <td width="31%" rowspan="4" valign="top" bgcolor="#FFFFFF" class="Letras1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><table width="69%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td><span class="textolink"><img src="../imagenes/servicios/<?php echo $rs["id"]; ?>.jpg" width="170"></span></td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                            </tr>
                        ...
                        <tr>
                          <td> <p class="titulos2"><a href="galeria.php?propiedad=<?php echo $rs["id"]; ?>" class="titulos2">Agregar Galería</a></p></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        </tr>
