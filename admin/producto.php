...
include("../Conexion.php");
	if ($_GET["action"]=="eliminar"){
		$insertar = "delete from producto WHERE id  = '$_GET[id]' " ; 
...
if ($_POST["Grabar"]){
		...
		$insertar="INSERT INTO producto (titulo,descripcion ) ";
...
<form action="producto.php" method="post" name="form1" id="form1">
    <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="35" colspan="2"><div align="center" class="textolink"><span class="titulo">Agregar un  nuevo Producto</span></div></td>
      </tr>
      <tr>
        <td width="44%" height="29" align="right"><span class="textolink">Producto<strong class="texto"> &nbsp; </strong></span></td>
                ...
                <tr>
                  <td width="88%" height="302" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <span class="textolink"><a href="producto.php?id=<?php echo $rs["id"] ?>&action=eliminar" onClick=" return confirm('¿Está Seguro que desea eliminar?');"><img src="b_drop.png" width="16" height="16" border="0" /></a>Eliminar</span></div></td>
                      <td width="50%" bgcolor="#FFFFFF" class="textopie2"><span class="textolink"><a href="javascript:openWindow('editarproductos.php?id=<?php echo $rs["id"]; ?>')"javascript:openWindow('editarproductos.php?id=<?php echo $rs["id"]; ?>')""><img src="Lapiz.png" width="16" height="16" border="0"></a>  &nbsp;<a href="javascript:openWindow('editarproducto.php?id=<?php echo $rs["id"]; ?>')" class="textolink">Editar</a></a></span></td>
                    </tr>
                    <tr>
                      ...
                      <td valign="top" bgcolor="#FFFFFF" class="textos"><a href="../imagenes/productos/Upload_pdf.php?id=<?php echo $rs["id"]; ?>" class="textolink3">SUBIR PDF</a></td>
                    </tr>
                    <tr>
                      <td height="26" align="right" valign="top" bgcolor="#FFFFFF" class="Letras1"><span class="textolink">Producto &nbsp; </span></td>
                    ...
                    <tr>
                      <td height="223" valign="top" bgcolor="#FFFFFF" class="Letras1">&nbsp;</td>
                    </tr>
                    <tr>
