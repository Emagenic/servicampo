...
if ($_POST["Grabar"]){
	$insertar="INSERT INTO galeria_producto (titulo,url,Tipo,propiedad) 
...
if ($_GET["fun"] =="eli"){
	$insertar = "delete from galeria_producto WHERE id = '".$_GET["id"]."' " ; 
	$sentencia=mysql_query($insertar,$conn)or die("Error al grabar un mensaje: ".mysql_error);
	
	$dir="../imagenes/galeria_producto/". $_GET["id"] .".jpg";
	if(file_exists($dir)) { 
		if(unlink($dir)) 
			print ""; 
		} else 
...
<body>
<form id="form1" name="form1" method="post" action="galeria_producto.php?propiedad=<?php echo $_GET["propiedad"] ?>">
...
<p align="center"><a href="producto.php" class="texto">Volver</a></p>
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
  <?php 
$listado = "select * from  galeria_producto where propiedad = '$_GET[propiedad]'";
...
?>
  <tr>
    <td width="25%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><a href="../imagenes/galeria_producto/Upload_foto.php?id=<?php echo $rs["id"]; ?>&amp;propiedad=<?php echo $_GET["propiedad"]; ?>" class="texto">Cambiar foto</a></td>
      </tr>
      <tr>
        <td align="center"><img src="../imagenes/galeria_producto/<?php echo $rs["id"]; ?>.jpg" width="177" /></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
      </tr>
      <tr>
        <td align="center"><a href="galeria_producto.php?id=<?php echo $rs["id"]; ?>&amp;fun=eli&amp;propiedad=<?php echo $_GET["propiedad"]; ?>" class="texto">Eliminar</a></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
      </tr>
