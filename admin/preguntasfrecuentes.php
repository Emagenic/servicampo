...
include("../Conexion.php");
	if ($_GET["action"]=="eliminar"){
		$insertar = "delete from pregunta WHERE id  = '$_GET[id]' " ; 
...
if ($_POST["Grabar"]){
		...
		$insertar="INSERT INTO pregunta (pregunta,respuesta ) ";
		$insertar.= "VALUES( '$_POST[pregunta]','$_POST[respuesta]')";
...
<form action="preguntasfrecuentes.php" method="post" name="form1" id="form1">
    <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="35" colspan="2"><div align="center" class="textolink"><span class="titulo">Agregar una nueva Pregunta</span></div></td>
      </tr>
      <tr>
        <td width="44%" height="29" align="right"><span class="textolink">Pregunta<strong class="texto"> &nbsp; </strong></span></td>
        <td width="56%">          <span class="textolink">
          <input name="nombre" type="text" class="boton2" id="nombre">        
        </span></td>
      </tr>
      <tr>
        <td height="94" align="right" valign="top" class="Letras1"><span class="textolink">Respuesta <strong> &nbsp; </strong></span></td>
        <td valign="top">
              ...
              <td height="265" bgcolor="#FFFFFF" class="margen"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="88%" height="302" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="300" valign="top" class="textolink"><a href="preguntasfrecuentes.php?id=<?php echo $rs["id"] ?>&action=eliminar" onClick=" return confirm('¿Está Seguro que desea eliminar?');"><img src="b_drop.png" width="16" height="16" border="0" /></a>Eliminar</td>
                      <td width="313" height="223" valign="bottom" class="textolink"><span class="textolink"><a href="javascript:openWindow('editar.php?id=<?php echo $rs["id"]; ?>')"javascript:openWindow('editar.php?id=<?php echo $rs["id"]; ?>')""><img src="Lapiz.png" width="16" height="16" border="0"></a>  &nbsp;<a href="javascript:openWindow('editar.php?id=<?php echo $rs["id"]; ?>')" class="textolink">Editar</a></a></span>
                        <p>&nbsp;</p>
                      <p>&nbsp;</p></td>
                    </tr>
                    <tr>
                      <td width="300" align="right" valign="top" class="texto">Pregunta&nbsp;&nbsp; </td>
                      <td height="63" valign="top" class="Letras1"><span class="textolink">
                        <?php $texto = str_replace("\r\n","<br>",$rs["pregunta"]); echo $texto ?>
                      </span></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" class="texto">Respuesta&nbsp;&nbsp;</td>
                      <td height="40" valign="top" class="Letras1"><p><span class="textolink">
                      <?php $texto = str_replace("\r\n","<br>",$rs["respuesta"]); echo $texto ?>
                      </span></p></td>
                    </tr>
                  </table></td>
                </tr>
