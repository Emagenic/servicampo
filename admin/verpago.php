...
<p align="center">
  <?php 
$listado = "select * from  pagos where codigo = '$_GET[id]' ";
...
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="141" valign="top" class="titulo"><span class="textolink2">Pagos</span></td>
  ...
  <tr>
    <td width="141" height="30" align="right" class="texto"><span class="textolink2">Factura</span></td>
    <td width="36">&nbsp;</td>
    <td width="993"><span class="textolink2"><?php echo $rs["Factura"];  ?></span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="right" valign="top" class="texto"><a href="../pagos/<?php echo $rs["nombrearchivo"];  ?>">Ver archivo adjunto</a></td>
    <td>&nbsp;</td>
    <td valign="top">&nbsp;</td>
  </tr>
</table>
