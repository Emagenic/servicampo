...
<table width="80%" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <?php 
$listado = "select * from  pagos  order by id desc";
$sentencia = mysql_query($listado,$conn);
while($rs=mysql_fetch_array($sentencia,$mibase)){
?>
  <tr>
    <td bgcolor="#FFFFFF"><span class="textolink2"><a href="verpago.php?id=<?php echo $rs["codigo"];  ?>" class="textolink2"><?php echo $rs["codigo"];  ?></a></span></td>
