...
if ($_POST["Modificar"]){
	$insertar = "UPDATE producto SET titulo ='$_POST[nombre]',descripcion ='$_POST[descripcion]' WHERE id  = '$_GET[id]' " ;
	$sentencia=mysql_query($insertar,$conn)or die("Error al grabar : ".mysql_error);


?>
	<script language="javascript">
	window.opener.document.location="producto.php"
	window.close();
	</script>	
<?php } ?>
...
?>
<form id="form1" name="form1" method="post" action="editarproducto.php?id=<?php echo $_GET["id"]; ?>">
    ...
    <tr>
      <td width="81%" valign="top"><p>
        ...
        <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="37" valign="top" class="textobox"><div align="right" class="titulo"><span class="textos">Producto</span><span class="titulos"> &nbsp;</span></div></td>
          ...
          <tr>
            <td height="102" valign="top" class="textobox"><div align="right" class="titulo"><span class="textos">Descripci&oacute;n </span><span class="titulos"> &nbsp;</span></div></td>
            <td valign="top" class="Letras1"><span class="textobox">
