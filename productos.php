    ...
    <div class="cont">
      <article>
        <div class="contenido_inicio">
          ...
          <p>Descripción del producto iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.<br></br>
          ...
          <a href="imagenes/productos/1.pdf" target="new">ver PDF</a>
        </div>
        <figure>
            <img src="imagenes/productos/1.jpg">  
          <div class="img_chica">
