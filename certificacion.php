...
<html lang="es">
  <head>
    ...
    <title>Certificación ISO Servicampo</title>
  ...
  <body class="home-page">
    ...
    <div class="cont">
      <article>
        ...
        <h3>Certificación y Permisos</h3>

        <h4>Misión</h4>

        <p>Servicampo cuenta con certificación de gestión y calidad.<br></br>
        Iso 9001-2008 a partir del año 2012<br></br>
        Trabajamos para satisfacer las necesidades de nuestros clientes, excediendo sus expectativas a través de un suministro de productos y servicios confiables, mejorando permanentemente nuestros procesos.</p>
        <a href="imagenes/nosotros/1.pdf" target="new">PDF</a>
      </div>
      <figure>
        <img src="imagenes/nosotros/veritas.jpg"><br></br>
        <img src="imagenes/nosotros/4.jpg">
      </figure>
      </article>
    </div>
